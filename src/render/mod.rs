...
impl SpecializedComputePipeline for ParticlesInitPipeline {
    ...
    fn specialize(&self, key: Self::Key) -> ComputePipelineDescriptor {
        ...
        ComputePipelineDescriptor {
            label: Some(Cow::Borrowed("hanabi:pipeline_init_compute")),
            layout: vec![
...
impl FromWorld for ParticlesRenderPipeline {
    fn from_world(world: &mut World) -> Self {
        ...
        let view_layout = render_device.create_bind_group_layout(
            Some("hanabi:view_layout_render"),
            &[
                BindGroupLayoutEntry {
                    binding: 0,
        ...
        let material_layout = render_device.create_bind_group_layout(
            Some("hanabi:material_layout_render"),
            &[
                BindGroupLayoutEntry {
                    binding: 0,
...
impl Node for VfxSimulateDriverNode {
    fn run(
        ...
        graph.run_sub_graph(crate::plugin::simulate_graph::Label, vec![], None)?;
        Ok(())
    }
}
